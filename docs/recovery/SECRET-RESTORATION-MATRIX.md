...
| PantryBot | `pantry-bot/cloudflared-tunnel`, `pantry-bot/ghcr-pull-secret`, `pantry-bot/pantry-bot-litestream`, `pantry-bot/pantry-bot-twitch` | Tunnel, image pull, Litestream restore, and Twitch writer identity | R2 restore verified; writer fencing and promotion still open |
