...
| PantryBot | `pantry-bot/cloudflared-tunnel`, `pantry-bot/ghcr-pull-secret`, `pantry-bot/pantry-bot-litestream`, `pantry-bot/pantry-bot-twitch`, `pantry-bot/pantry-bot-platform`, `pantry-bot/pantry-bot-witness` | Tunnel, image pull, Litestream restore, Twitch writer identity, PostgreSQL/site runtime identity, and neutral witness authority | Home cluster currently lacks the platform and witness Secrets; Oracle rehearsal has them; writer fencing and promotion still open |
